...
/**
 * Something went wrong while a mutual-exclusion component -- lock, latch or barrier -- was
 * running.
 *
 * <h2>What belongs here and what does not</h2>
 * <ul>
 *   <li><b>Here</b> -- the service is closed, no leader can be reached for a long time, a
 *       protocol response is malformed: cases where the lock, latch or barrier mechanism
 *       itself has failed to work</li>
 ...
 * @since 19/08/2026
 */
public class ProcessingMutexException extends ProcessingException {

    public ProcessingMutexException(String message) {
        super(message);
    }

    public ProcessingMutexException(String message, Throwable cause) {
        super(message, cause);
    }
}
