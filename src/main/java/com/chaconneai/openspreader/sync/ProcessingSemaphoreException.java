...
/**
 * Something went wrong while the distributed semaphore was running.
 *
 * <h2>What belongs here and what does not</h2>
 * <ul>
 *   <li><b>Here</b> -- the service is closed, no leader can be reached for a long time, a
 *       protocol response is malformed: cases where the semaphore mechanism itself has
 *       failed to work</li>
 ...
 * @since 19/08/2026
 */
public class ProcessingSemaphoreException extends ProcessingException {

    public ProcessingSemaphoreException(String message) {
        super(message);
    }

    public ProcessingSemaphoreException(String message, Throwable cause) {
        super(message, cause);
    }
}
